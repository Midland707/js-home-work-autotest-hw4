...
const calculateTotalBalance = users => users.reduce((totalBalance, total) => {
  return totalBalance + total.balance;
}, 0);
// Change code above this line

calculateTotalBalance(loadUsers);
console.log("TotalBalance - ", calculateTotalBalance(loadUsers));
