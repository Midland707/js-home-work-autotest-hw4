...
const getUsersWithAge = (users, minAge, maxAge) => users.filter(user => maxAge > user.age && user.age > minAge);

// Change code above this line
getUsersWithAge(userLoad, 20, 30);
getUsersWithAge(userLoad, 30, 40);
getUsersWithAge(userLoad, 80, 100);

console.log("=== minAge і maxAge дорівнюють 20 і 30 === ", getUsersWithAge(userLoad, 20, 30));
console.log("=== minAge і maxAge дорівнюють 30 і 40 === ", getUsersWithAge(userLoad, 30, 40));
console.log("=== minAge і maxAge дорівнюють 80 і 100 === ", getUsersWithAge(userLoad, 80, 100));
