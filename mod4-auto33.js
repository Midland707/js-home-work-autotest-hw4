...
isAnyUserActive(loadUsers);
console.log("Є активні користувачі ? - ", isAnyUserActive(loadUsers));

// Доповни функцію isAnyUserActive(users) таким чином, щоб вона
// перевіряла наявність активних користувачів(властивість isActive) і повертала true або false.
