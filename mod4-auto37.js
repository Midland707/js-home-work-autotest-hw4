...
const getTotalFriendCount = users => users.reduce((sumFriends, value) => {
  return sumFriends + value.friends.length;
}, 0);
// Change code above this line

getTotalFriendCount(loadUsers);
console.log("TotalBalance - ", getTotalFriendCount(loadUsers));
